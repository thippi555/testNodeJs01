...
define(["require", "exports", "../Common/RestClientBase"], function (require, exports, RestClientBase_1) {
    ...
    var ManagementRestClient = /** @class */ (function (_super) {
         ...
         * @param plan -
         */
        ManagementRestClient.prototype.createBillingSnapshot3 = function (meterUsage, plan) {
         ...
         */
        ManagementRestClient.prototype.getBillableCommitterDetails3 = function (plan, billingDate) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param plan -
         */
        ManagementRestClient.prototype.getLastMeterUsage3 = function (plan) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param billingDate - The date to query, or if not provided, today
         */
        ManagementRestClient.prototype.getMeterUsage3 = function (plan, billingDate) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        ManagementRestClient.prototype.getOrgEnablementStatus3 = function (includeAllProperties) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        ManagementRestClient.prototype.updateOrgEnablementStatus3 = function (orgEnablementSettings) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.3",
         ...
         */
        ManagementRestClient.prototype.getEstimatedBillablePushersDetailsForOrg3 = function (plan) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param includeAllProperties - When true, also determine if pushes are blocked if they contain secrets
         */
        ManagementRestClient.prototype.getProjectEnablementStatus3 = function (project, includeAllProperties) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         * @param project - Project ID or project name
         */
        ManagementRestClient.prototype.updateProjectEnablementStatus3 = function (projectEnablementSettings, project) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.3",
         ...
         * @param plan -
         */
        ManagementRestClient.prototype.getEstimatedBillablePushersDetailsForProject3 = function (project, plan) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        ManagementRestClient.prototype.getRepoEnablementStatus3 = function (project, repository, includeAllProperties) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
         ...
         */
        ManagementRestClient.prototype.updateRepoAdvSecEnablementStatus3 = function (savedAdvSecEnablementStatus, project, repository) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.beginRequest({
                            apiVersion: "7.2-preview.3",
         ...
         * @param plan - The plan to query.
         */
        ManagementRestClient.prototype.getEstimatedBillableCommittersDetailsForRepo3 = function (project, repository, plan) {
            return __awaiter(this, void 0, void 0, function () {
                var queryValues;
                return __generator(this, function (_a) {
                    queryValues = {
